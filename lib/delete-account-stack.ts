...
export class DeleteAccountStack extends Stack {
  constructor(scope: Construct, id: string, props?: StackProps) {
    super(scope, id, props);

    // Lambda function triggered by scheduler
    const executeMemo = new cdk.aws_lambda_nodejs.NodejsFunction(
      this,
      "ExecuteMemo",
      {
    ...
    const api = new cdk.aws_apigateway.RestApi(this, "Api", {
      restApiName: "DeleteAccountStack",
    });
    api.root
      .addResource("addMemo")
      .addMethod("POST", new cdk.aws_apigateway.LambdaIntegration(addMemo));
  }
}
